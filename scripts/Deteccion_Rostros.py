...
def capture_faces_from_video(video_path, max_images, frame_skip=FRAME_SKIP):
    ...
    with mp.solutions.face_detection.FaceDetection(model_selection=1, min_detection_confidence=0.15) as detector:
        while count < max_images:
            ...
            if results.detections:
                for det in results.detections:
                    ...
                    face_resized = cv2.resize(face, OUTPUT_IMAGE_SIZE)
...
def main():
    personas_videos = {
        ...
        'Carlos Hernandez': ['CarlosH1.mp4', 'CarlosHernandez2.mp4'],
        ...
        'Lucia Cardenas': ['Lucia1.mp4', 'Lucia2.mp4'],
        'Andrea Pipino': ['Andrea1.mp4', 'Andrea2.mp4']
    }
